...
<!-- #ifdef APP-VUE || MP-WEIXIN || MP-QQ || H5 -->
<script src="../../uni_modules/z-paging/components/z-paging/wxs/z-paging-wxs.wxs" module="pagingWxs" lang="wxs"></script>
<!-- #endif -->

<!-- #ifdef APP-VUE || H5 -->
<script module="pagingRenderjs" lang="renderjs">
	import pagingRenderjs from '../../uni_modules/z-paging/components/z-paging/wxs/z-paging-renderjs.js';
	/**
	 * z-paging 分页组件
...
<script src="../../uni_modules/z-paging/components/z-paging/js/z-paging-main.js" />

<style scoped>
	@import "../../uni_modules/z-paging/components/z-paging/css/z-paging-main.css";
	@import "../../uni_modules/z-paging/components/z-paging/css/z-paging-static.css";
  .zp-scroll-view {
    display: flex;
