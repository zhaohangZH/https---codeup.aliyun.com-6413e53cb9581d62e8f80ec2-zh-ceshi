<template>
  <view class="u-search" :style="{ margin: margin }" @tap="clickHandler">
    <view
      class="u-content"
      :style="{
    ...
    >
      ...
      <view v-if="keyword && clearabled && focused" class="u-close-wrap" @tap="clear">
        <!-- <uni-icons
          ...
          color="#c0c4cc"
        ></uni-icons> -->
        <text style="color: #981a20" :style="{ 'font-size': closeIconSize + 'px' }">清除</text>
      </view>
    </view>
    <view
      class="u-action"
...
<script setup>
const searchIconSize = uni.upx2px(40)
const closeIconSize = uni.upx2px(24)
</script>
<script>
/**
 * search 搜索框
